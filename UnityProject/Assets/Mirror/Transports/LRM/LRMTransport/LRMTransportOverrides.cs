    ...
    public partial class LightReflectiveMirrorTransport : Transport {
        ...
        public override void ServerStart () {
            ...
            if (useNATPunch) {
                ...
                _clientSendBuffer.WriteInt (ref pos, _directConnectModule == null ? 1 :
                    _directConnectModule.SupportsNATPunch () ? _directConnectModule.GetTransportPort () : 1);
            }

            _clientSendBuffer.WriteInt (ref pos, appId);
            _clientSendBuffer.WriteString (ref pos, Application.version);
            _clientSendBuffer.WriteString (ref pos, groupId); // Moved to match server order
            _clientSendBuffer.WriteInt (ref pos, authorityLevel); // Moved to match server order
